 ...
 */
public class OglHistoryFragment extends BaseFragment {

    FragmentOglHistoryBinding binding;
    ...
    public OglHistoryFragment() {
        // Required empty public constructor
    }

    public static OglHistoryFragment newInstance() {

        Bundle args = new Bundle();
        OglHistoryFragment fragment = new OglHistoryFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentOglHistoryBinding.inflate(inflater, container, false);
        ...
        binding.btnSubmit.setOnClickListener(v -> {
          String date1= binding.selectDate1.getText().toString();
            ...
            if(!date1.equals("")&&!date2.equals("")) {
                ...
                viewModel.getOglHistory(oglHistoryRequest, mActivity, "1");
            }else{
